class RegisterUtil {
    ...
    async createAccount(request) {
        ...
        await account.customer().create({account_id:account.account_id,first_name,last_name,age,gender,user_rate:'0',previllage:'normal',reservation:'0',cancle:'0',coin:'0'})
